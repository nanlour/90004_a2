...
class MuscleFiber:
    ...
    # Regulate nutrient, set upper limit of nutrient store for each cell.
    def __regulate_nutrient(self):
        self.nutrient = min(MuscleModel.nutrient_max, self.nutrient)

    # Each day MuscleFiber will get constant amount of nutrient
    def get_nutrient(self):
        self.nutrient += MuscleModel.nutrient
        self.__regulate_nutrient()

    # Perform daily activity that affects hormone levels.
    ...
    # Exercise promotes hormone secretion
    ...
    # Regulate Hormones for gien upper and lower bound
    ...
    # Regulate muscle fibers for gien upper and lower bound
...
class MuscleModel:
    ...
    # Generate normally distributed value for given mean and std_dev.
    ...
    # Get eight neighbors of given position.
    ...
    # Get normally distributed sleep hours based on given argument
    def getSleepHours():
        sleep_hours = -1
